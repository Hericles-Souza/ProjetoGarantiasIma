...
const DialogCreateAccount: React.FC<CreateAccountProps> = ({
  isVisible,
  onClose,
}) => {
  ...
  const onFinish = async () => {
    try {
      ...
      message.error("Erro ao enviar a solicitação? ", error);
    }
  };
        ...
        >
          <Input
            ...
            style={{
              ...
              fontSize: "18px",
              borderRadius: "10px",
              borderColor: focusedField === "corporateName" ? "red" : "",
            }}
        ...
        >
          <Input
            ...
            style={{
              ...
              fontSize: "18px",
              borderRadius: "10px",
              borderColor: focusedField === "email" ? "red" : "",
            }}
