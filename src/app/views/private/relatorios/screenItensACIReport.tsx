...
import { getAllItensACI } from "@shared/services/AcordoComercialService";
...
const ItensACIReportScreen: React.FC = () => {
    ...
    useEffect(() => {
        const fetchItensACI = async () => {
            setLoading(true);
            try {
                const response = await getAllItensACI();
    ...
    const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Relatorio_Itens_ACI");
        XLSX.writeFile(workbook, "relatorio_itens_aci.xlsx");
    };
...
export default ItensACIReportScreen;