...
import { RightOutlined, DownOutlined, LeftOutlined, InfoCircleOutlined } from "@ant-design/icons";
    ...
    return (
        <div className={styles.containerApp}>
            <div className={styles.containerBotaoVoltar}>
                <Button type="link" className={styles.botaoVoltar}>
            ...
            <div className={styles.containerCabecalho}>
                ...
                <div className={styles.botoesCabecalho}>
                    ...
                    <Button style={{ backgroundColor: "red", borderRadius: "10px" }} type="primary" className="enviar">ENVIAR</Button>
                </div>
            </div>
         ...
         <h3 className={styles.nfsTitle}>Itens desta NF associados a esta garantia</h3>
            <Button className={styles.buttonRed} style={{ backgroundColor: "red", borderRadius: "10px", height: "40px" }} type="primary">
                ADICIONAR ANEXO
            </Button>
         </div>
